...
function song1() {
  ...
  bop.style.color = "white"drop.style.backgroundColor = "#0a050a";
  drop.style.color = "#3f3f3f"window.open("https://www.youtube.com/watch?v=5GcPA3C0QeI", "_blank");
}
function song2() {
  ...
  bop.style.backgroundColor = "#FF8C87";
  bop.style.color = "white"drop.style.backgroundColor = "#0a050a";
  drop.style.color = "#3f3f3f"window.open("https://www.youtube.com/watch?v=n9DmdAwUbxc", "_blank");
}
function song3() {
  ...
  bop.style.backgroundColor = "#FF8C87";
  bop.style.color = "white"drop.style.backgroundColor = "#0a050a";
  drop.style.color = "#3f3f3f"window.open("https://www.youtube.com/watch?v=jq6kaCcFE7c", "_blank");
}
function drop1() {
  var bop = document.getElementById("bop-btn1");
  var drop = document.getElementById("drop-btn1");
  drop.style.backgroundColor = "#FF8C87";
  drop.style.color = "white"bop.style.backgroundColor = "#0a050a";
